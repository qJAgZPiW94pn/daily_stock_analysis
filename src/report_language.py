...
_OPERATION_ADVICE_TRANSLATIONS = {
    "strong_buy": {"zh": "强烈買入", "en": "Strong Buy"},
    "buy": {"zh": "買入", "en": "Buy"},
    "hold": {"zh": "持有", "en": "Hold"},
    "watch": {"zh": "观望", "en": "Watch"},
    "reduce": {"zh": "减仓", "en": "Reduce"},
    "sell": {"zh": "賣出", "en": "Sell"},
    "strong_sell": {"zh": "强烈賣出", "en": "Strong Sell"},
}
...
_REPORT_LABELS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "source_label": "行情来源",
        "data_perspective_heading": "數據透视",
        "ma_alignment_label": "均线排列",
        "bullish_alignment_label": "多头排列",
        "yes_label": "是",
        "no_label": "否",
        "trend_strength_label": "趨勢强度",
        "price_metrics_label": "价格指標",
        "ma5_label": "MA5",
        "ma10_label": "MA10",
        "ma20_label": "MA20",
        ...
        "ideal_buy_label": "理想買入点",
        "secondary_buy_label": "次优買入点",
        "stop_loss_label": "止损位",
        "take_profit_label": "目标位",
        "suggested_position_label": "仓位建议",
        "entry_plan_label": "建仓策略",
        "risk_control_label": "风控策略",
        "checklist_heading": "檢查清单",
        "failed_checks_heading": "檢查未通过项",
        ...
        "position_advice_heading": "持倉建议",
        "analysis_model_label": "分析模型",
        "not_investment_advice": "AI生成，仅供參考，不构成投资建议",
        "details_report_hint": "詳細报告见",
    },
    "en": {
