...
CN_BLUEPRINT = MarketStrategyBlueprint(
    region="cn",
    title="A股市场三段式复盘策略",
    positioning="聚焦指數趨勢、資金博弈与板塊轮动，形成次日交易计划。",
    principles=[
    ...
    dimensions=[
        ...
        StrategyDimension(
            name="資金情绪",
            objective="识别短线風險偏好与情绪温度。",
            checkpoints=["漲跌家数与漲跌停结构", "成交额是否扩张", "高位股是否出现分歧"],
        ),
        StrategyDimension(
            name="主线板塊",
            objective="提炼可交易主线与规避方向。",
            checkpoints=["领涨板塊是否具备事件催化", "板塊内部是否有龙头带动", "领跌板塊是否扩散"],
        ),
    ],
    action_framework=[
...
HK_BLUEPRINT = MarketStrategyBlueprint(
    region="hk",
    title="港股市场三段式复盘策略",
    positioning="聚焦恒生指數趨勢、南向資金博弈与板塊轮动，形成次日交易计划。",
    principles=[
    ...
    dimensions=[
        ...
        StrategyDimension(
            name="主线板塊",
            objective="提炼可交易主线与规避方向。",
            checkpoints=["科技/互联网平台趨勢持续性", "金融/地产对政策转向的敏感度", "防御与成长因子轮动"],
        ),
    ],
    action_framework=[
