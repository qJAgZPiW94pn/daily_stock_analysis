...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    "STOCK_LIST": {
        ...
        "docs": [
            {
                "label": "完整指南：环境變數完整列表",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#环境變數完整列表",
            },
            {
    ...
    "ANTHROPIC_MAX_TOKENS": {
        ...
        "description": "Anthropic API 回應最大 token 数（默认 8192）。",
        "category": "ai_model",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
