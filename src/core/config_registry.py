...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
        ...
        "docs": [
            {
                ...
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/LLM_CONFIG_GUIDE.md#方式三litellm-原生-yaml-配置适合专家或複雜路由",
            },
        ],
    ...
    "ANTHROPIC_MAX_TOKENS": {
        ...
        "description": "Anthropic API 回應最大 token 数（預設 8192）。",
        "category": "ai_model",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "EMAIL_SENDER": {
        ...
        "docs": [
            {
                "label": "完整指南：電郵",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#電郵",
            },
        ],
        "warning_codes": [],
    },
    ...
    "WEBUI_HOST": {
        ...
        "docs": [
            ...
            },
            {
                ...
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#webui-与-api-服務",
            },
        ],
